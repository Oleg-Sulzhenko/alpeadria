...
jQuery(document).ready(function(){
    ...
    $('.tfuse_rf_post_datepicker_in').datepicker({
        ...
        {
            inst.dpDiv.css({marginTop: -input.offsetHeight+36 + 'px'});
        }
...
function showErrorMessage(textMessage){
    var $=jQuery;
    _message= _form.closest('.contact-form').find('#form_messages').css("background-color", "#ffffff").html('<h2>'+textMessage+'</h2>').addClass('error_submiting_form').show();
    _form.hide();
    jQuery('.reservationForm .add-comment-title, .reservationForm .comment-form').hide();
}
...
function showSuccessMessage(textMessage){
    var $=jQuery;
    _message=  _form.closest('.contact-form').find('#form_messages').css("background-color", "#ffffff").html('<h2>'+textMessage+'</h2>').addClass('success_submited_form').show();
    _form.hide();
    jQuery('.reservationForm .add-comment-title, .reservationForm .comment-form').hide();
}
