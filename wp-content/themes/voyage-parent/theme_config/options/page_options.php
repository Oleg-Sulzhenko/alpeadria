...
$options = array(
    ...
    array('name' => __('Disable Breadcrumbs', 'tfuse'),
        ...
        'value' => tfuse_options('disable_breadcrumbs',false),
        'type' => 'checkbox',
        'divider' => true
    ),
    // Disable After Content
    array('name' => __('Disable After Content', 'tfuse'),
        'desc' => '',
        'id' => TF_THEME_PREFIX . '_disable_after_content',
        'value' => tfuse_options('disable_after_content_pages','false'),
        'type' => 'checkbox',
        'divider' => true
    ),
    // Page Title
