...
function tf_reservationform_shortcode($atts){
    ...
    if($form_exists){
        ...
        <a onclick="document.reservationForm.reset();return false" href="#" class="link-reset">' . urldecode($form['reset_button']) . '</a>
...
function res_captcha($input,$form_input){
    ...
    if(__($form_input['label_text'],'tfuse')) $out .="<label for='" .TF_THEME_PREFIX.'_'.trim($form_input['shortcode']). "'>".__($form_input['label_text'],'tfuse')."</label><br>";
