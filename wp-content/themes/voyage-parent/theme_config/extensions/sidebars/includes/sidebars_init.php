...
function tf_sidebars_init() {
    ...
    register_sidebar(array('name' => __('After Content 1', 'tfuse'), 'id' => 'after-content-1', 'before_widget' => $beforeWidget, 'after_widget' => $afterWidget, 'before_title' => $beforeTitle, 'after_title' => $afterTitle));
    register_sidebar(array('name' => __('After Content 2', 'tfuse'), 'id' => 'after-content-2', 'before_widget' => $beforeWidget, 'after_widget' => $afterWidget, 'before_title' => $beforeTitle, 'after_title' => $afterTitle));
    register_sidebar(array('name' => __('After Content 3', 'tfuse'), 'id' => 'after-content-3', 'before_widget' => $beforeWidget, 'after_widget' => $afterWidget, 'before_title' => $beforeTitle, 'after_title' => $afterTitle));
}
