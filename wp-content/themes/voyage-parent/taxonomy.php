    ...
    <div class="container_12">
        ...
        <div class="content">
            ...
            <div class="title">
                <?php if ($tag->count > 0) : ?>
                <h1>
                    <?php print mb_strtoupper(TF_SEEK_HELPER::get_option('seek_property_name_plural'), 'UTF-8'); print ' ';  _e('IN', 'tfuse'); ?> <span><?php print mb_strtoupper(tfuse_qtranslate($tag->name), 'UTF-8'); ?></span>
                    <span class="title_right count"><?php  print $total_properties; print ($total_properties > 1) ? __(' available offers', 'tfuse') : __(' available offer', 'tfuse'); ?></span>
                </h1>
                <?php endif; ?>
            </div>
